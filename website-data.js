...
const websiteData = {
  ...
  countdowns: [
    {
      ...
      targetDate: "2026-09-24T00:00:00-12:00",
      color: "black"
    },
    {
  ...
  // Important dates
  dates: [
    { label: "Paper submission deadline", value: "<del style='font-weight: 400;'>September 7, 2026</del> September 23, 2026 (AoE)" },
  ...
  programCommittee: [
    ...
    { name: "Jana Giceva", affiliation: "Technical University of Munich" },
    { name: "João P. C. Lima", affiliation: "TU Dresden" },
    { name: "Mohammad Loni", affiliation: "Volvo Autonomous Solutions" },
    { name: "Haiyu Mao", affiliation: "King’s College London" },
    { name: "Geraldo F. Oliveira", affiliation: "Huawei" },
    { name: "Daniele Passaretti", affiliation: "Otto-von-Guericke University Magdeburg" },
